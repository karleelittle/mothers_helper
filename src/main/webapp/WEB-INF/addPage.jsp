...
<body>
	<div class="container gradient-custom-purp vh-100 mw-100 p-5">
		<div class="navbar p-2 mb-5">
			...
			<div>
				<form:form action="/grocerys" modelAttribute="grocery" class="form" method="post">
				...
				<div class="form-row">
					...
					<form:textarea rows="10" cols="30" path="items" class="form-control" placeholder="Milk, Eggs, Bread.."/>
				</div>
				<div class="text-center p-2">
					<input type="submit" value="Create List" class="btn btn-lg btn-white" style="background-color: #4835d4; color:white"/>
				</div>
				</form:form>
			</div>
		</div>
